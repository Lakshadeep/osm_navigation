...
void Odom::SetModel( odom_model_t type, double alpha1, double alpha2, double alpha3, double alpha4, double alpha5 )
{
...
bool Odom::UpdateAction(pf_t *pf, SensorData *data)
{
    ...
    semantic_map_t* map = (semantic_map_t*)pf->random_pose_data;
